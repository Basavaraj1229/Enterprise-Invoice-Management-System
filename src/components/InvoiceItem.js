...
class InvoiceItem extends React.Component {
  render() {
    ...
    var currency = this.props.currency; // now an object {symbol, code, label, locale}
      ...
      <tr>
        ...
        <td style={{minWidth: '130px'}}>
          <EditableField
            onItemizedItemEdit={this.props.onItemizedItemEdit}
            cellData={{
            leading: this.props.currency && this.props.currency.symbol ? this.props.currency.symbol : this.props.currency,
            type: "number",
            name: "price",
            min: 1,
            step: "0.01",
